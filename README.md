...
|:------------------------------------------------|---------------------------------------------------------------|-------------------------------|---------------------:|
| Conceptual Domain Model (Business)              | Business analyst                                              | Describe the domain           | MER - Class Diagramm                                                                                                                                                             without OPP Elements                                                                                                                              (business) entities and thei                                                                                                                                                      interrelationships:                                                                                                                                                               Regardless of the System      
